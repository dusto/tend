...
var Methods = []Method{
	...
	{Name: "file.open", Direction: PluginToDaemon, Params: FileOpenParams{}, Result: FileOpenResult{}, Summary: "Open a repo file in the session's bound editor for the user to see (non-mutating, not task-gated, worktree-bounded); a no-op for a headless session (open=false)."},
